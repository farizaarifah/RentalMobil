...
<body>
	...
	<div class="row" style="margin-top: 10px">
		...
		<div class="col-md-10">
			...
			<h2>DATA SEWA</h2>
			<a href="FormTambahSewa2.php" type="button" class="btn btn-warning">Tambah</a>
			...
			<table class="table table-bordered" style="padding-top: 5 px">
			  ...
			  <tbody>
			    ...
			    include 'koneksi.php';
			    $no = 1;
			    $data = mysqli_query($koneksi,"SELECT * FROM tb_sewa INNER JOIN tb_penyewa ON tb_sewa.id_penyewa = tb_penyewa.id_penyewa");
			    ...
			    <tr>
			      ...
			      <td>
			      	<a href="FormEditSewa.php?id_sewa= <?php echo $d['id_sewa'];?>" type="button" class="btn btn-primary">Ubah</a>
			      	<a href="fungsiHapusSewa.php?id_sewa=<?php echo $d['id_sewa']; ?>"type="button" class="btn btn-danger">Hapus</a>
			      </td>
			    </tr>
